...
//        Helper.navigateToElement(BedRoomPage.bedPicture);
    ...
    public void user_should_click_add_to_inventory_rug_in_dining_room() {
        for (WebElement value:diningRoomPage.allNameOfPictureDiningRoom) {
            System.out.println(Helper.color("purple")+"Items in Dining Room:\n"+value.getText()+Helper.color("reset"));
        }
    }
